...
agendar_cita=LabelFrame(ventana_principal, text="Agendar Cita", padx=5, pady=5, bg=color3)
...
escojer_especialidades.grid(row=0,column=0)
especialidades=[
...
escojer_modalidad.grid(row=1,column=0)
...
ingresar_paciente.grid(row=2, column=0)
