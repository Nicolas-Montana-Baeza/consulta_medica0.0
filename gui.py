...
class GuiDominio(Tk):
    ...
    def __init__(self):
        ...
        self.apellido1=Entry(self.ingresar_paciente, width=10).grid(row=5,column=1)
        ...
        self.citas_agendadas.pack(anchor=W)
        self.citas_agendadas2=Label(self.citas_agendadas, text="Ingrese su codigo: ", bg=self.color3).grid(row=0,column=0)
        self.citas_agendadas3=Entry(self.citas_agendadas, width=30).grid(row=0,column=1)
        self.boton_aceptar=Button(self.citas_agendadas,text="Buscar").grid(row=0,column=2)
        self.boton_agendar_hora=Button(self.citas_agendadas,text="Confirmar").grid(row=1,column=2)
        self.boton_cancelar_hora=Button(self.citas_agendadas,text="Cancelar").grid(row=1,column=3)
        self.boton_editar_hora=Button(self.citas_agendadas,text="Reagendar").grid(row=1,column=4)
